...
CKEDITOR.editorConfig = function (config) {
	...
	config.extraPlugins = 'html5video_v1,preview,container,rowspacingbottom,rowspacingtop,div,colorbutton,lineheight,letterspacing,colordialog,simage,justify,quicktable,imagepaste';
