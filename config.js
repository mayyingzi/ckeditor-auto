...
CKEDITOR.editorConfig = function (config) {
	...
	config.extraPlugins = 'preview,container,rowspacingbottom,rowspacingtop,div,colorbutton,lineheight,letterspacing,colordialog,simage,justify,quicktable,imagepaste';
